...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(
        file=r"C:\Facial-Recognition-for-Crime-Detection-master\img\back.png")
...
logo = tk.PhotoImage(file=r"C:\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
